        ...
        <div className="grid grid-cols-3 gap-1 mb-2">
          {[
            ...
            <div key={label} className={label === "Vehicle" ? "text-right" : ""}>
              ...
              <p className={`text-xs font-semibold text-slate-800  ${color || ""} ${upper ? "uppercase" : ""}`}>{value}</p>
            </div>
          ))}
        </div>
                      ...
                      {filteredTrips.map((t, idx) => {
                        ...
                        return (
                          <tr key={t._id} className="border-b border-slate-100 hover:bg-amber-50/30 even:bg-slate-50/40 transition-colors">
                            ...
                            <td className="px-2.5 py-2 text-[10px] text-black font-semibold whitespace-nowrap">{new Date(t.createdAt).toLocaleDateString("en-GB")}</td>
                            ...
                            <td className="px-2.5 py-2 text-[11px] text-black font-semibold max-w-[110px] truncate">{t.driverName}</td>
                            <td className="px-2.5 py-2 text-[10px] text-black font-semibold uppercase font-mono">{t.vehicleNumber}</td>
